...
const SearchFilters = async () => {
  ...
  return (
    ...
    <div className="flex md:flex-col items-center md:items-stretch gap-2 py-2 md:py-4 px-4 md:px-6 lg:pt-4 lg:pb-2">
      ...
      <Suspense fallback={ <Button
        ...
        >
<svg aria-hidden="true" role="status" className="inline w-4 h-4 text-white animate-spin" viewBox="0 0 100 101" fill="black" xmlns="http://www.w3.org/2000/svg">
