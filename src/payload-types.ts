...
export interface Tenant {
  id: string;
  /**
   * The name of the store (e.g Hamas's Store
   */
  username: string;
  /**
   * The unique domain for the store (e.g. hamas.gumroad.com)
   */
  slug: string;
  /**
   * The image for the store (e.g. logo, avatar, etc.)
   */
...
export interface Order {
  ...
  /**
   * The Stripe Account associated with this order.
   */
